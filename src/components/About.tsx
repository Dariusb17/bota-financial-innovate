        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 flex justify-center">
            <div className="relative">
              ...
              <img
                ref={imageRef}
                src="/lovable-uploads/3feec78d-7976-4742-83c2-cfa7b2526d62.png"
                alt="Alin-Alexandru Bota"
                className="rounded-lg shadow-xl max-w-sm w-full h-auto object-cover transition-all duration-700 opacity-0 scale-95"
              />
            </div>
          </div>
          ...
          <div 
            ref={observerRef} 
            className="lg:w-1/2 opacity-0 translate-y-10 transition-all duration-700"
          >
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#0A66C2] text-white rounded-lg hover:bg-[#0A66C2]/90 transition-colors"
              >
                <Linkedin size={20} />
                LinkedIn
              </a>
